...
namespace Org.BouncyCastle.Crypto.Signers
{
     ...
     */
    public class ECGOST34102012Signer : IDsa
    {
        ECKeyParameters key;

        SecureRandom random;

        public string AlgorithmName => "ECGOST3410-2012-256";
        ...
        public BigInteger[] GenerateSignature(byte[] message)
        {
            ...
            do // generate s
            {
                ...
                do // generate r
                {
                    ...
                    ECPoint p = basePointMultiplier.Multiply(ec.G, k)
                        .Normalize();
                ...
                s = (k.Multiply(e)).Add(d.Multiply(r))
                    .Mod(n);
            }
            while (s.SignValue == 0);
        ...
        public bool VerifySignature(byte[] message, BigInteger r, BigInteger s)
        {
            ...
            BigInteger z1 = s.Multiply(v)
                .Mod(n);
            BigInteger z2 = (n.Subtract(r)).Multiply(v)
                .Mod(n);

            ECPoint G = key.Parameters
                .G; // P
            ...
            BigInteger R = point.AffineXCoord
                .ToBigInteger()
                .Mod(n);
