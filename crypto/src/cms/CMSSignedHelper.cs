...
namespace Org.BouncyCastle.Cms
{
    internal class CmsSignedHelper
    {
		...
		static CmsSignedHelper()
		{
			...
			encryptionAlgs.Add(RosstandartObjectIdentifiers.id_tc26_signwithdigest_gost_3410_12_256.Id, "ECGOST3410-2012-256");
			encryptionAlgs.Add(RosstandartObjectIdentifiers.id_tc26_signwithdigest_gost_3410_12_512.Id, "ECGOST3410-2012-512");
